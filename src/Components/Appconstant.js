...
export const socialicons = [
  ...
  {text: 'Facebook', icon: 'fab fa-facebook', link: 'https://www.facebook.com/rockstar_615/'},
  {text: 'Instagram', icon: 'fab fa-instagram', link: 'https://www.instagram.com/rockey_star_615/'},
  {text: 'Pinterest', icon: 'fab fa-pinterest'},
  {text: 'YouTube', icon: 'fab fa-youtube', link: 'https://www.youtube.com/@rocky-star-s9v'},
]
...
export const contactboxes = [
  ...
  {
    title: 'Email Me',
    text: 'pradeeppal8867256@gmail.com',
    link: 'mailto:pradeeppal8867256@gmail.com',
    icon: 'fad fa-envelope'
  },
  {
    title: 'Visit Me',
    text: '7461 Ahmedabad St. Ahmedabad, FL 32566',
    link: 'https://maps.app.goo.gl/zBgCfzHfr2aY7Z5T9',
